...
const updateProduct = async (
  ...
  //TODO Es posible que tendremos un localhost:3000/products/img.jpg
  ...
  try {
    ...
    //TODO ELIMINAR FOTOS EN CLOUDDINARY SI SE ELIMINAN
    // https://res.cloudinary.com/mochomos/image/upload/v1649791256/l33zmwf52js3csmsqc77.jpg
...
const createPoriduct = async (
  ...
  //TODO porsiblemente tendremos un localhost:3000/products/ asfdsaf.jpg
  ...
  try {
    ...
    if (productInDB) {
      ...
      return res
        .status(400)
        .json({ message: "Ya existe un producto con este slug" });
    }
